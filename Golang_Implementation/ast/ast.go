...
//list of parsed statements that make was made up of the inputted program
type Program struct {
...
type IfExpression struct {
	...
	Condition   Expression      //holds the condition, which can be any expression
	Consequence *BlockStatement //just a series of statements. That’s exactly what ast.BlockStatement represents
	Alternative *BlockStatement //just a series of statements. That’s exactly what ast.BlockStatement represents
}
